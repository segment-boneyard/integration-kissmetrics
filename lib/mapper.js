...
exports.identify = function(identify){
  ...
  var payload = {};
  var ip = identify.ip();
  var shouldTrackIp = identify.proxy('context.trackIp');
  payload.identify = clean(identify.traits());
  if (shouldTrackIp && ip) {
    payload.identify._ip = identify.ip();
  }
...
exports.group = function(group){
  ...
  var ip = group.ip();
  var shouldTrackIp = group.proxy('context.trackIp');
  if (shouldTrackIp && ip) {
    payload._ip = ip;
  }
...
exports.page = function(page) {
  ...
  var shouldTrackIp = page.proxy('context.trackIp');
  var ip = page.ip();
  if (shouldTrackIp && ip) {
    properties._ip = ip;
  }
...
function createBaseTrackProperties(track, settings) {
  ...
  var shouldTrackIp = track.proxy('context.trackIp');
  var shouldTrackUserAgent = track.proxy('context.trackUserAgent');
...
exports.alias = function(alias){
  var shouldTrackIp = alias.proxy('context.trackIp');
  var ip = alias.ip();
  var properties = {
    _k: this.settings.apiKey,
    _p: alias.from(),
